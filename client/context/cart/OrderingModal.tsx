    ...
    switch (type) {
      case "empty":
        return (
          ...
          >
            ...
            <Text className="text-center text-text-4 text-base font-outfit-light">
      ...
      case "conflict":
        return (
          ...
          >
            <Text className="text-center text-text-3 text-2xl font-outfit-bold">
              ¿Querés crear un nuevo pedido?
            </Text>

            <Text className="text-center text-text-5 text-base font-outfit-light mb-6">
              Para hacerlo tenemos que eliminar los productos que agregaste
              anteriormente de{" "}
              <Text className="font-outfit-bold text-black">
                {items[0]?.local.name}
              </Text>
              .
            </Text>
