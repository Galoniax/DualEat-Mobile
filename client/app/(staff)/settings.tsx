...
import { update } from "@/services/auth.api";
  ...
  return (
    ...
    >
      ...
      <View className="px-4 py-4 bg-white border-b border-gray-100 flex-row items-center">
        ...
        <Text className="text-[22px] font-outfit-bold text-text-3">
          Configuración
        </Text>
      </View>
      ...
      >
        ...
        <View className="mb-6">
          <Text className="text-[15px] font-outfit-regular text-text-5 mb-2 ml-1">
            Nombre Completo
          </Text>
          <View className="bg-white flex-row items-center px-4 h-14 rounded-2xl border border-gray-200">
            ...
            <TextInput
              ...
              className="flex-1 ml-3 font-outfit-regular text-[16px] text-text-3"
            />
          </View>
        </View>

        {/* SECCIÓN SEGURIDAD */}
        <Text className="text-[18px] font-outfit-bold text-text-3 mb-4 mt-4">
        ...
        >
          {loading ? (
            ...
            <>
              <Text className="text-white font-outfit-bold text-[18px] mr-2">
                Guardar Cambios
              </Text>
