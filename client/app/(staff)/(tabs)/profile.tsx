  ...
  return (
    <SafeAreaView edges={["top"]} className="flex-1 bg-bg-gray">
      ...
      <View className="px-6 py-4 bg-white border-b border-gray-100 flex-row justify-between items-center z-10">
        <Text className="text-[24px] font-outfit-bold text-text-3">
          Mi Perfil
        </Text>
        <TouchableOpacity
      ...
      >
        ...
        <View className="bg-white px-6 py-8 items-center border-b border-gray-100">
          ...
          <Text className="text-[26px] font-outfit-bold text-text-3 tracking-tight">
            {user?.name}
          </Text>
          <Text className="text-[15px] font-outfit-regular text-text-6 mb-4">
            {user?.email}
          </Text>
          ...
          <View className="bg-bg-red px-5 py-2 rounded-full flex-row items-center">
            <Ionicons
              ...
              style={{ marginRight: 6 }}
            />
            <Text className="text-white text-[13px] font-outfit-bold uppercase tracking-widest">
              Staff Oficial
            </Text>
          </View>
        </View>
        ...
        <View className="px-6 mt-8">
          <Text className="text-[18px] font-outfit-bold text-text-3 mb-4 ml-1">
            Mis Locales
          </Text>
          ...
          {workplaces.map((w) => (
            ...
            >
              ...
              <View className="flex-1">
                <Text className="text-[17px] font-outfit-bold text-text-3">
                  {w.name}
                </Text>
                <Text className="text-[14px] font-outfit-regular text-text-6 capitalize">
                  {w.role}
                </Text>
              </View>
            </View>
          ...
          {workplaces.length === 0 && (
            <View className="bg-white rounded-2xl p-6 items-center border border-gray-100 border-dashed">
              <Ionicons
                ...
                className="mb-2"
              />
              <Text className="text-[15px] font-outfit-regular text-text-4 text-center">
        ...
        <View className="px-6 mt-8">
          ...
          <View className="bg-white rounded-3xl overflow-hidden border border-gray-100">
            ...
            >
              ...
              <Text className="flex-1 text-[16px] font-outfit-regular text-text-3">
            ...
            >
              ...
              <Text className="flex-1 text-[16px] font-outfit-bold text-red-500">
                Cerrar Sesión
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <Text className="text-center text-[13px] font-outfit-regular text-text-6 mt-10">
          DualEat Staff v1.0.2
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
