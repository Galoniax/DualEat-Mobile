  ...
  },
  {
    ...
    icons: {
      default: (color: string, size: number) => (
        <Image
          source={{
            uri: "https://img.icons8.com/material-outlined/24/map-marker.png",
          }}
      ...
      focused: (color: string, size: number) => (
        <Image
          source={{
            uri: "https://img.icons8.com/material/24/map-marker--v1.png",
          }}
          style={{ width: size, height: size, tintColor: color }}
        />
      ),
  ...
  },
  {
    ...
    icons: {
      default: (color: string, size: number) => (
        <Image
          source={{
            uri: "https://img.icons8.com/material-outlined/50/purchase-order.png",
          }}
          style={{ width: size, height: size, tintColor: color }}
        />
      ),
      focused: (color: string, size: number) => (
        <Image
          source={{
            uri: "https://img.icons8.com/material/24/purchase-order--v1.png",
          }}
          style={{ width: size, height: size, tintColor: color }}
        />
      ),
  ...
  },
  {
    ...
    icons: {
      default: (color: string, size: number) => (
        <Image
          source={{
            uri: "https://img.icons8.com/fluency-systems-regular/48/name.png",
          }}
          style={{ width: size, height: size, tintColor: color }}
        />
      ),
      focused: (color: string, size: number) => (
        <Image
          source={{
            uri: "https://img.icons8.com/fluency-systems-filled/48/name.png",
          }}
          style={{ width: size, height: size, tintColor: color }}
        />
      ),
...
export default function TabsOutLayout() {
  return (
    <Tab data={tabs} />
  );
}